...
This script implements a minimal and explicit pipeline to compute gene-wise variance from a gene expression matrix.
...
The goal is to prepare the ground for feature selectoin, not to filter yet.
"""
...
def main():
    ...
    print("✓ Step 4 finished: variance computed\n")
